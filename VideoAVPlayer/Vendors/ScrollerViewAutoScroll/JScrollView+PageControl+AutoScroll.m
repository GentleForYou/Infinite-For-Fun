...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        _viewDes = [[UIView alloc] initWithFrame:CGRectMake(0, self.frame.size.height - 20, self.frame.size.width, 20)];
        _viewDes.backgroundColor = [UIColor colorWithRed:0.9 green:0.9 blue:0.9 alpha:0.5];
        [self addSubview:_viewDes];
        
        _pageControl = [[UIPageControl alloc] initWithFrame:CGRectMake(_viewDes.frame.size.width * 3 / 4 , 0, _viewDes.frame.size.width / 4, _viewDes.frame.size.height)];
        _pageControl.userInteractionEnabled = NO;
        _pageControl.pageIndicatorTintColor = [UIColor colorWithRed:0.7 green:0.7 blue:0.7 alpha:1];
        _pageControl.currentPageIndicatorTintColor = [UIColor redColor];
        [_viewDes addSubview:_pageControl];
